          ...
          children: [
            ...
            ListTile(
              ...
              trailing: currentSort == BrowserSortOption.name
                  ? Icon(isAscending ? Icons.arrow_upward_rounded : Icons.arrow_downward_rounded, color: colors.accentPrimary)
                  : null,
              onTap: () {
            ...
            ListTile(
              ...
              trailing: currentGroup == BrowserGroupOption.none
                  ? Icon(Icons.check_rounded, color: colors.accentPrimary)
                  : null,
              onTap: () {
                onGroupChanged(BrowserGroupOption.none);
                Navigator.pop(context);
              },
            ),
          ],
