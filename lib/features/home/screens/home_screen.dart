...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget _buildLoading() {
    ...
    final statusText =
        syncState is SyncInProgress ? syncState.status : 'Loading…';
    return Center(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          ClipRRect(
            ...
            child: LinearProgressIndicator(
              ...
              minHeight: 6,
              backgroundColor:
                  isDark ? const Color(0xFF2A2A45) : const Color(0xFFE8E4FF),
  ...
  Widget _statRow() {
    ...
    return Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
      _statPill(Icons.insert_drive_file_rounded, '${hive?.totalFiles ?? 0}',
          'Files', AppTheme.primary),
      div,
      _statPill(Icons.cloud_done_outlined,
          _formatSize(_meta?.storageUsedMb ?? 0), 'Used', AppTheme.secondary),
      div,
      _statPill(
          Icons.all_inclusive_rounded, '∞', 'Limit', const Color(0xFF10B981)),
    ]);
  }
      ...
      builder: (ctx) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              leading:
                  const Icon(Icons.download_rounded, color: AppTheme.success),
              title: const Text('Download Directly',
                  style: TextStyle(fontWeight: FontWeight.w600)),
            ...
            ListTile(
              leading: const Icon(Icons.downloading_rounded,
                  color: AppTheme.primary),
              title: const Text('Download in Background',
                  style: TextStyle(fontWeight: FontWeight.w600)),
...
class _RecentTile extends StatelessWidget {
  ...
  const _RecentTile(
      {required this.file, required this.isLast, required this.onTap});
