...
/// Screen component showing comprehensive storage capacity and cloud metrics.
class StorageDetailsScreen extends StatelessWidget {
  /// Constructs StorageDetailsScreen.
  ...
  /// Builds row card displaying cloud diagnostic item.
  Widget _buildTile(
