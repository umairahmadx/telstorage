...
class _SyncScreenState extends State<SyncScreen> {
  ...
  Widget _buildStatusCard(AppColorsExtension colors, SyncQueueService syncQueue, int pendingCount) {
    final statusText = !_isDeviceOnline
        ? 'Offline — Changes Queued'
        : (pendingCount > 0 ? 'Syncing $pendingCount item(s)...' : 'All Changes Synced');
        ...
        children: [
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              ...
              label: Text(
                'Sync Now',
                style: TextStyle(fontWeight: FontWeight.bold, color: colors.bgPrimary),
              ),
