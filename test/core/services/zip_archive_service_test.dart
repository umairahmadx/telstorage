...
void main() {
  test(
      'TC-01: createZipFromFiles creates valid zip archive with nested entry paths',
      () async {
    final tempDir = await Directory.systemTemp.createTemp('zip_unit_test_');
    final file1 = File('${tempDir.path}/hello.txt')
      ..writeAsStringSync('Hello World');
    final nestedDir = Directory('${tempDir.path}/nested')..createSync();
    final file2 = File('${nestedDir.path}/doc.pdf')
      ..writeAsStringSync('%PDF-1.4 dummy content');
