...
// These intentionally implement only one capability. If a use case depended
// on the composite repository contract, these tests would no longer compile.
...
void main() {
  ...
  group('DomainEventBus Tests', () {
    ...
    test('DomainEventBus type-filtered stream ignores unrelated events', () async {
      ...
      // Listen only for FileDeletedEvent
